...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/xorg-libsm-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/xorg-libsm-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install xorg-libsm
```
...
It is possible to list all of the versions of `xorg-libsm` available on your platform:
...
```
pixi search xorg-libsm --channel conda-forge
```
